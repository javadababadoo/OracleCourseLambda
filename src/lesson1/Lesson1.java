...
public class Lesson1 {
    ...
    private void exercise1() {
        ...
        list.stream().forEach(word -> text.append(word.substring(0, 1)));
    ...
    private void exercise2() {
        ...
        list.removeIf(value -> value.length() % 2 != 0);
    ...
    private void exercise4() {
        ...
        map.entrySet().stream().map((k) -> k.getKey() + k.getValue()).forEach(stringValue -> string.append(stringValue));
